...
def compute_mean_sq_diff(adata_1, adata_2, cell_id_1, cell_id_2, layers):
...
def compute_mean_sq_diff_wgd(adata_1, adata_2, cell_id_1, cell_id_2, layers):
    cell_idx_1 = adata_1.obs.index.get_loc(cell_id_1)
    cell_idx_2 = adata_2.obs.index.get_loc(cell_id_2)
    distance0 = 0
    for layer in layers:
...
def compute_distances(adata_1, adata_2=None, obs_ids_1=None, cn_layers=('cn_norm_ploidy',)):
    ...
    for obs_id in tqdm.tqdm(obs_ids_1):
        ...
        for obs_id2 in adata_2.obs.index:
            distances.append({
                'obs_id_1': obs_id,
                'obs_id_2': obs_id2,
                'copy_mean_sq_distance': compute_mean_sq_diff(adata_1, adata_2, obs_id, obs_id2, cn_layers),
                'copy_mean_sq_wgd_distance': compute_mean_sq_diff_wgd(adata_1, adata_2, obs_id, obs_id2, cn_layers),
            })
